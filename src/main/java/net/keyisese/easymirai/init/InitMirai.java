package net.keyisese.easymirai.init;


import net.keyisese.easymirai.configuration.MyConfiguration;
...
public class InitMirai {
    ...
    public Bot start() {
        // Java
        Bot bot = BotFactory.INSTANCE.newBot(configuration.getUsername(), configuration.getPassword(), new BotConfiguration() {{
            // 配置，例如：
            fileBasedDeviceInfo();
